...
function CanvasPlaceholder(): JSX.Element {
  return (
    <PanelShell
      title="Canvas"
      subtitle="Excalidraw wrapper (PR #13)"
      tone="elevated"
    >
      <p className="text-[13px] leading-5 text-dc-text-secondary">
        The real <code className="font-mono">&lt;Excalidraw /&gt;</code>{' '}
        component plus MCP scene-sync lands in PR #13. Rendering it here would
        also pull in the unstyled full-screen canvas and hide the layout
        chrome we want to verify.
      </p>
    </PanelShell>
  );
}
